...
class CfgWorlds
{
	...
	class BrienZ_Meiringen: ChernarusPlus
	{
		worldId=2;
		cutscenes[]={};
		description="BrienZ_Meiringen";
		icon="";
		worldName="BrienZ_Meiringen\BrienZ_Meiringen.wrp";
		pictureMap="";
		pictureShot="";
